...
const company_supports_payment = false
...
<div class="file-form-presentation last-box">
    <div class = "mat-back mat-back-2"  style="height:fit-content" >
        <div class="file-data">
            <span>Operation:</span> 
        ...
        <div class="file-data">
            <span style="white-space:nowrap;"><span>Name:</span> {name}</span>
            <span style="white-space:nowrap;"><span>Size:</span> {size}</span>
            <span style="white-space:nowrap;"><span>Mime Type:</span> {mime_type}</span>
            <span style="white-space:nowrap;"><span>User Selected:</span> {user_picked_type}</span>
            <span style="white-space:nowrap;"><span>Data Type:</span> {type_class}</span>
            <span style="white-space:nowrap;"><span>Data Format:</span> {type_special}</span>
        </div>
    </div>
    <div>
        <div class = "mat-back mat-back-2 form" style="white-space:nowrap;height:35pxoverflow-x:auto">
            <span>Asset ID: </span><input type="text" id="asset-id" >&nbsp;&nbsp;
            {#if company_supports_payment }
    ...
    <div class = "mat-back" style="heigth:0;width:100%;overflow-y:auto">
        ...
        <div class = "mat-back-2" >
            <div class = "form" >
                ...
                <span style="color:blue;font-size: larger;">&nbsp;&RightArrowBar;&nbsp;</span>
                <div style="display:inline-block;padding-left:2px;padding-right:2px;border: 1px solid navy;">
                    {#if been_published }
                    <span style="color: rgb(6, 32, 6);font-weight: 700;">Published</span>
                    {:else}
                    <span style="white-space:nowrap;color: rgb(6, 32, 6);font-weight: 600;">Not yet published</span>
                    {/if}
                </div>
                <div style="display:inline-block;padding-left:2px;padding-right:2px;border: 1px solid navy;">
                    {#if locally_stored }
                    <span style="color: rgb(6, 32, 6);font-weight: 700;">Stored</span>
                    {:else}
                    <span style="white-space:nowrap;color: rgb(6, 32, 6);font-weight: 600;">Not Stored</span>
                    {/if}
                </div>
                <div style="display:inline-block;padding-left:2px;padding-right:2px;border: 1px solid navy;">
                    {#if uploaded }
                    <span style="color: rgb(6, 32, 6);font-weight: 700;">Uploaded</span>
                    {:else}
                    <span style="white-space:nowrap;color: rgb(6, 32, 6);font-weight: 600;">Not Uploaded</span>
                    {/if}
                </div>
                <div class = "field">
